...
X1=read.csv("SelectX1_Lung.csv")
X2=read.csv("SelectX2_Lung.csv")
Y1=read.csv("Y1_Lung.csv",header = FALSE)
Y2=read.csv("Y2_Lung.csv",header = FALSE)
...
write.csv(re,paste0('realdata',"lung",'.csv'))
